                ...
                >
                  <div className="card__front p-4 text-center">
                    ...
                    <div className="flow-content gap-1 mt-6">
                      ...
                      <p className="card__position text-sm text-bold font-mono text-white">EELECTRÓNICA</p>
                    </div>
                  </div>
                </div>
              </Link>
                ...
                >
                  <div className="card__front p-4 text-center">
                    ...
                    <div className="flow-content gap-1 mt-6">
                      ...
                      <p className="card__position text-sm text-bold font-mono text-white">ELECTRÓNICA</p>
                    </div>
                  </div>
                </div>
              </Link>
