                    ...
                    <form onSubmit={onSubmit3}>
                        ...
                        <div className="bg-zinc-900 p-4 rounded-lg mb-4">
                            ...
                            <h1 className="text-gray-400 font-sans font-semibold">
                                - Algún comentario u observación a la boleta que esta emitiendo.
                            </h1>
                            <h1 className="text-gray-400 font-sans font-semibold">
                                - Documentos relacionados a la boleta.
                            </h1>
                            <h1 className="text-gray-400 font-sans font-semibold">
                                - Información relacionada a la boleta.
                            </h1>
                        </div>

                        <div className="bg-zinc-900 p-4 rounded-lg mb-4">
                            <h1 className="text-lg font-semibold text-yellow-100 mb-4">
                                Consigne las observaciones de la Boleta de Venta.
                            </h1>
                            <input
                        ...
                        <div className="bg-zinc-900 p-4 rounded-lg mb-4">
                            <h1 className="text-lg font-semibold text-yellow-100 mb-4">
                                Consigne los documentos relacionados de la Boleta de Venta.
                            </h1>
                            ...
                            <div id="documentosRelacionados" style={{ display: mostrarDocumentosRelacionados ? 'block' : 'none' }}>
                                <div className="bg-zinc-800 p-4 rounded-lg mb-4">
                                    <h1 className="text-lg font-semibold text-yellow-100 mb-4">
                                        Ingrese los documentos relacionados a la Boleta de Venta Electronica:
                                    </h1>
                        ...
                        <div className="bg-zinc-900 p-4 rounded-lg mb-4">
                            <h1 className="text-lg font-semibold text-yellow-100 mb-4">
                                Consigne Información Relacionada a la Boleta de Venta.
                            </h1>
                            <div className="flex justify-center">
                                <input
