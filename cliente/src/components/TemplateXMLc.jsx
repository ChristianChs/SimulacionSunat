    ...
    <Document>
      <Page size='A4' style={styles.page}>
        <View style={{ marginTop: 10 }}>
          ...
          <View style={styles.section}>
            <Text style={[styles.label, { marginLeft: 20 }]}>&lt;cuota2&gt;</Text>
          </View>
          ...
          <View style={styles.section}>
            <Text style={[styles.label, { marginLeft: 20 }]}>&lt;cuota3&gt;</Text>
          </View>
          ...
          <View style={styles.section}>
            <Text style={[styles.label, { marginLeft: 20 }]}>&lt;cuota4&gt;</Text>
          </View>
          ...
          <View style={styles.section}>
            <Text style={[styles.label, { marginLeft: 20 }]}>&lt;cuota5&gt;</Text>
          </View>
