  ...
  return (
    <Document>
      <Page size='A4' style={styles.page}>
        <View>
            <View>
                <Text style={styles.title}>PRELIMINAR DE FACTURA ELECTRÓNICA</Text>
            </View>

            <View style={styles.header}>
                <View style={{ marginTop: 10 }}>
                    <Text style={styles.title}>INVERSIONES PEREZ</Text>
                    <Text style={styles.title}>PEREZ SALAZAR WILDER ABRAHAN</Text>
