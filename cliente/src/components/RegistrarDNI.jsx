...
function RegistrarDNI({ signin }) {
    ...
    const verificarDNI = async (dni) => {
        ...
        const response = await fetch(apiUrl);eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9.eyJlbWFpbCI6InNpeW9jaTc3MzJAdGVuamIuY29tIn0.WgWY5BFPV4U0Vc6gHxPS2T67pZSvdvpTeUWobW1BhTo
